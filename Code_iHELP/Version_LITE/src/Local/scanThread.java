...
public class scanThread implements Runnable , Serializable {
	...
	static LinkedList<Long > all ;
	static JLabel label ;
	

	public scanThread(String Path , LinkedList<Fileapp> pdf , LinkedList<Fileapp> img , LinkedList<Fileapp> web , LinkedList<Fileapp> archife , LinkedList<Fileapp> doc ,LinkedList<Fileapp> programation ,LinkedList<Fileapp> dossier,LinkedList<Fileapp> other,LinkedList<Long> all,JLabel label) {
		id=count++;
		this.Path = Path;
		this.pdf=pdf;
		this.img=img;
